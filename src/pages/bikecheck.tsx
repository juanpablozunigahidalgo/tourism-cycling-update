      ...
      >
        ...
        <div>
          ...
          <div>
                ...
                <div style={{ width: '50%' }}>
                {/* Here it goes the First Omni import */}
                    <div className="omni-calculator" data-calculator="sports/bike-size" data-width="300" data-config='{}' data-currency="SEK" data-show-row-controls="false" data-version="3" data-t="1684490260184">
                    <div className="omni-calculator-header">Bike Size Calculator</div>
                    <div className="omni-calculator-footer">
                    <a href="https://www.omnicalculator.com/sports/bike-size" target="_blank"><img alt="Omni" className="omni-calculator-logo" src="https://cdn.omnicalculator.com/embed/omni-calculator-logo-long.svg" /></a>
                    </div>
                    </div>
                ...
                <div style={{ width: '50%' }}>
                  {/* Here it goes the Second Omni import */}
                  <div className="omni-calculator" data-calculator="sports/bike-gear-calculator" data-width="300" data-config='{}' data-currency="SEK" data-show-row-controls="false" data-version="3" data-t="1684490477615">
                  <div className="omni-calculator-header">Bike Gear Calculator</div>
                  <div className="omni-calculator-footer">
                    <a href="https://www.omnicalculator.com/sports/bike-gear-calculator" target="_blank"><img alt="Omni" className="omni-calculator-logo" src="https://cdn.omnicalculator.com/embed/omni-calculator-logo-long.svg" /></a>
                  </div>
                </div>
                <script async src="https://cdn.omnicalculator.com/sdk.js"></script>
                </div>
